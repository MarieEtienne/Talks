...
PrintBibliography(myBib, start = 15, end = 21)
```
...
```{r refs_4, echo=FALSE, results="asis", eval = TRUE, cache = FALSE}
PrintBibliography(myBib, start = 22, end = 28)
```
...
```{r refs_5, echo=FALSE, results="asis", eval = TRUE, cache = FALSE}
PrintBibliography(myBib, start = 29, end = 30)
```
